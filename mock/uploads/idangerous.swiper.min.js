...
var Swiper = function(f, b) {
		...
		function U() {
			for (var b = a.paginationButtons, d = 0; d < b.length; d++) a.h.removeEventListener(b[d], "mouseenter", V, !1)
		}
		function V(b) {
			var d;
		...
		if ((document.querySelectorAll || window.jQuery) && "undefined" !== typeof f && (f.nodeType || 0 !== g(f).length)) {
			...
			a.createPagination = function(c) {
				...
				if (b.paginationClickable) for (c = a.paginationButtons, d = 0; d < c.length; d++) a.h.addEventListener(c[d], "mouseenter", V, !1)
			};
...
$(function() {
	$('.card-list dl dd').bind("mouseover", function() {
		$(this).css("background", "#fffef6")
	})
	$('.card-list dl dd').bind("mouseout", function() {
